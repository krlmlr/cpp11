...
- Nested calls to `cpp11::unwind_protect()` are no longer supported or
  ...
  [`vignette("FAQ")`](https://cpp11.r-lib.org/articles/FAQ.md) section
  titled “Should I call `cpp11::unwind_protect()` manually?”
...
- [`cpp_register()`](https://cpp11.r-lib.org/reference/cpp_register.md)
...
- [`cpp_source()`](https://cpp11.r-lib.org/reference/cpp_source.md)
...
- Fixed bug when running
  [`cpp_source()`](https://cpp11.r-lib.org/reference/cpp_source.md) on
...
- [`cpp_source()`](https://cpp11.r-lib.org/reference/cpp_source.md) now
  gets an argument `dir` to allow customized temporary directory to
...
- [`cpp_source()`](https://cpp11.r-lib.org/reference/cpp_source.md) now
  has much more informative error messages when compilation fails
  ([\#125](https://github.com/r-lib/cpp11/issues/125),
  [\#139](https://github.com/r-lib/cpp11/issues/139))
- [`cpp_source()`](https://cpp11.r-lib.org/reference/cpp_source.md) now
  uses a unique name for the DLL, so works when run multiple times on
  the same source file on Windows
...
- [`cpp_source()`](https://cpp11.r-lib.org/reference/cpp_source.md) can
  now accept a source file called `cpp11.cpp`
...
- [`cpp_source()`](https://cpp11.r-lib.org/reference/cpp_source.md),
  ...
  and [`cpp_eval()`](https://cpp11.r-lib.org/reference/cpp_source.md)
